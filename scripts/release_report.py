#!/usr/bin/env python3
"""
release_report.py — Gemini SEO v1.9.0 Pro Hub Challenge Release Report
...
def chart_skill_architecture(charts_dir: Path) -> str:
    ...
    ax.set_title("Gemini SEO Skill Architecture: v1.9.0 (23 Total Skills)",
...
<div class="title-page">
  {logo_html}<div class="badge">Agent Skills Standard</div>
  <h1>Gemini SEO v1.9.0<br>Release Report</h1>
  ...
  <div class="meta">
    Version 1.9.0 &nbsp;&#183;&nbsp; {date} &nbsp;&#183;&nbsp; github.com/avalonreset/gemini-seo
  </div>
...
{items}  </ul>
  <div style="margin-top:10mm; padding:4mm 5mm; background:#111111; border-left:3px solid #E07850; border-radius:0 4px 4px 0; font-size:9pt; color:#D0CFC8;">
    v1.9.0 is the first community-driven Gemini SEO release. Six members submitted skills for the inaugural Pro Hub Challenge. Five shipped. This report covers the contributions, architecture changes, review process, and security findings in full.
  </div>
</div>"""
...
<div class="section">
  <div class="section-header">
    ...
    <div class="smeta">Gemini SEO v1.9.0, April 2026</div>
  </div>
...
<div class="section">
  ...
  <p>The Pro Hub Challenge is a community extension program in AI Marketing Hub Pro. Members submit agent SEO skills for gemini-seo or related tools. Winning submissions get integrated into the official release. The inaugural challenge offered $600 in AI credits across prize tiers.</p>
    ...
    contributors = [
        ...
        },
        {
            ...
            "points": [
                ...
                "SQLite persistence at ~/.cache/gemini-seo/drift/baselines.db",
...
def _build_architecture_section(chart_path: str, fig_num: int) -> tuple:
    chart = _chart_html(chart_path,
                        "Gemini SEO skill architecture: 23 skills by category (orange = v1.9.0 additions)",
                        fig_num)
    html = f"""
<div class="section">
  <div class="section-header">
...
<div class="section">
  ...
  <div class="success-box" style="margin-top:5mm;">
    ...
    <p>Challenge v2 is live in AI Marketing Hub Pro. The keyword is <strong style="color:#4ADE80;">LEADS</strong>. Build anything that touches lead generation: agent SEO skills, n8n workflows, MCP servers, dashboards, scrapers, pipelines. If it helps someone capture, qualify, nurture, or convert leads, it counts.</p>
  ...
  <p style="font-size:8.5pt; color:#888888; text-align:center; margin-top:4mm;">
    Gemini SEO is open-source (Agent Skills standard) &nbsp;&#183;&nbsp;
    github.com/avalonreset/gemini-seo &nbsp;&#183;&nbsp;
...
def generate_report(output_dir: str, screenshots_dir: str = SCREENSHOTS_DIR) -> str:
    ...
    charts_dir = out / "gemini-seo-v190-charts"
    ...
    pdf_path = out / "Gemini-SEO-v1.9.0-Release-Report.pdf"
    ...
    try:
        ...
        html_out = out / "Gemini-SEO-v1.9.0-Release-Report.html"
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate Gemini SEO v1.9.0 Pro Hub Challenge Release Report"
    )
