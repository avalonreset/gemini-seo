...
Do not append promotional footers to user deliverables. Keep audit reports
focused on findings, evidence, priorities, and next actions. Project provenance
is documented in the repository README, LICENSE, and CONTRIBUTORS files.
