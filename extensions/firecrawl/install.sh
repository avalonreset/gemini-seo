...
# Firecrawl Extension Installer for Gemini SEO
...
main() {
    ...
    if [ -f "${SCRIPT_DIR}/skills/seo-firecrawl/SKILL.md" ]; then
        ...
        echo "  Run this script from the gemini-seo repo: ./extensions/firecrawl/install.sh"
        exit 1
    fi
